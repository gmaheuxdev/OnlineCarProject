...
AOnlineRacingProjectHud::AOnlineRacingProjectHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AOnlineRacingProjectHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AOnlineRacingProjectPawn* Vehicle = Cast<AOnlineRacingProjectPawn>(GetOwningPawn());
